...
namespace TensorFlowSharpCore
{
	...
	public class TFBuffer : TFDisposable
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:TensorFlowSharpCore.TFBuffer"/> by wrapping the unmanaged resource pointed by the buffer.
		/// </summary>
		...
		/// <remarks>
		/// This constructor wraps the buffer as a the data to be held by the <see cref="T:TensorFlowSharpCore.TFBuffer"/>,
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:TensorFlowSharpCore.TFBuffer"/> by making a copy of the provided byte array.
		/// </summary>
